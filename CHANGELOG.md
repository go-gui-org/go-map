...
- Bump go-gui v0.78.0 → v0.79.0 (no source changes needed).
...
- Bump go-gui v0.75.0 → v0.76.0.

## v0.11.0 - 2026-09-12

- Bump go-gui v0.74.0 → v0.75.0.
...
- Bump go-gui v0.69.0 → v0.72.0 (go-glyph v1.25.1 indirect). CI drops native
  deps and bumps actions.
